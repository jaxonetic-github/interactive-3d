...
button1.src ="images/textures/SquareRed.png";
var buttonData1 = { name:"red", image:button1, x:320 - 96 - 30, y:10, w:32, h:32 };
buttons.push( buttonData1 );

var button2 = new Image();
button2.src ="images/textures/SquareGreen.png";
var buttonData2 = { name:"green", image:button2, x:320 - 64 - 20, y:10, w:32, h:32 };
buttons.push( buttonData2 );

var button3 = new Image();
button3.src ="images/textures/SquareBlue.png";
var buttonData3 = { name:"blue", image:button3, x:320 - 32 - 10, y:10, w:32, h:32 };
buttons.push( buttonData3 );

	var redTexture = THREE.ImageUtils.loadTexture( 'images/textures/SquareRed.png' );
	var blueTexture = THREE.ImageUtils.loadTexture( 'images/textures/SquareBlue.png' );
	var greenTexture = THREE.ImageUtils.loadTexture( 'images/textures/SquareGreen.png' );
...
//	browsingScene.add(bridgePlatform);
	 ...
	 welcomeTextContainer.add(	  sayAt("interacting with this site. ",
	  ...
	  phraseRotation, 0x666006,30,14)); 	
	  	...
	  	//  sayAt("but there will b",browsingSceneCenter.x+textAlignment,50,browsingSceneCenter.z,  phraseRotation, 0x666006,25,5); 
	  	  ...
	  	  var texture = new THREE.ImageUtils.loadTexture( 'images/me.png' );
	...
	addPageToContainer(browsingScene,"http://jaxonetic.0fees.us/jaxonetic/Pages/aboutme/nolayout",1);
	addPageToContainer(browsingScene,"http://jaxonetic.0fees.us/jaxonetic/Jaxcontact/index/nolayout",3);
	addPageToContainer(browsingScene,"http://jaxonetic.0fees.us/jaxonetic/Projects/index/nolayout",0);
